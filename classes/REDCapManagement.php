...
class REDCapManagement {
    ...
    public static function getProjectConstantsArrayWithoutDeactivatedProjects(){
        ...
        $RecordSetSettings = \REDCap::getData(PROJECT_ID, 'array', null);
    ...
    public static function getMetadataFieldsToScreen() {
        return array("required_field", "field_name", "field_label", "form_name", "field_type", "identifier", "branching_logic", "section_header", "field_annotation", "select_choices_or_calculations", "text_validation_type_or_show_slider_number", "text_validation_min", "text_validation_max");
